...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_05bcc64c9729430c851bf36903496d69
    """
    try:
        ...
        auth_package_secret_key = """v9bvlB2hSz4k1NIx8HzmOQVe-9JIaqWuEiOVo8QYXGQ="""
...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_5f5d4111b1304f329d8ac345cbaf5e56
    """
    try:
